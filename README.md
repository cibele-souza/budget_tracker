...
To enable Google Drive sync, create a project in the Google Cloud Console, enable the Google Drive API, and create an OAuth 2.0 client ID. Then add your client ID to a .env file at the project root:
...
BankFormatBoursoBankCSVHello BankXLS
...
→ [LinkedIn](my personal LinkedIn profile)
